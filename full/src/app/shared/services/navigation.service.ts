...
export class NavigationService {
  iconMenu: IMenuItem[] = [
    ...
    },
    {
      ...
      sub: [
        { name: 'Add Bank Account', state: 'bankaccount/addBankAccount' },
        { name: 'All Accounts', state: 'bankaccount/getAllAccounts' },
        { name: 'Currency Converter', state: 'bankaccount/Convertercurrency' }
            ]
    },
    {
      name: 'Data Table',
