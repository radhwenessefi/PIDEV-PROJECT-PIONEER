...
export const rootRouterConfig: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'bankaccount',
        loadChildren: () => import('./views/bank-account-transaction/bank-account-transaction.module').then(m => m.BankAccountTransactionModule),
        data: { title: 'BankAccount', breadcrumb: 'BankAccount'}
      }
